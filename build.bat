...
SET DEBUG=1
SET IFLAGS=/Iinclude
SET CFLAGS=/Fe%TITLE% /nologo /W4 /GR /EHa /Oi /fp:fast /FC /link /INCREMENTAL:NO /opt:ref /subsystem:windows /entry:WinMainCRTStartup user32.lib gdi32.lib opengl32.lib Comdlg32.lib winsqlite3.lib
